                    ...
                    <div class="card">
                        <form action="{{route('user.update',$user->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="page-title"> <font color="red"> Edit Company Details</font></h4>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="department" class="form-control" id="job_type" value="{{$user->department}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="designation" class="form-control" id="job_type" value="{{$user->designation}}">
                                    </div>
                                </div>

                                        <input type="number" name="salary" class="form-control" value="{{$user->salary}}" hidden>


                                <h4 class="page-title"> <font color="red"> Edit Requirements</font></h4>
                                <div class="form-group row">
                                    <label for="tin" class="col-sm-3 text-right control-label col-form-label">Tin #</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="tin" class="form-control" id="join_date" value="{{$user->tin}}">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="sss" class="col-sm-3 text-right control-label col-form-label">SSS #</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="sss" class="form-control" id="job_type" value="{{$user->sss}}">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="phic" class="col-sm-3 text-right control-label col-form-label">PHIC #</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="phic" class="form-control" id="job_type" value="{{$user->phic}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="hmdf" class="col-sm-3 text-right control-label col-form-label">HMDF #</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="hmdf" class="form-control" value="{{$user->hmdf}}">
                                    </div>
                                </div>
