            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">Admin</h5>    <a href="{{route('user.create')}}" class="btn btn-md btn-primary">Add New Employee</a>
                            </div>
                            <div class="table-responsive">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            Tin: <font color="blue"> <strong> {{$user->tin}}</strong></font><br>
                                            SSS: <font color="blue"> <strong>{{$user->sss}}</strong></font><br>
                                            PHIC: <font color="blue"><strong>{{$user->phic}}</strong></font><br>
                                            HMDF: <font color="blue"><strong>{{$user->hmdf}}</strong></font>
                                        </td>
                                        <td>
                                            <button type="button"
