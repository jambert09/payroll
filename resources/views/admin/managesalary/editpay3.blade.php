        ...
        <div class="page-breadcrumb">
            ...
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center btn-block btn-lg btn-dark">
                    ...
                    <a class="btn-lg btn-primary" href="#"data-position="center">Edit-Payroll</a>
            ...
            <div id="app" class="container-fluid">
                <div class="row" v-for="(item, i) in items">
                    <div class="col-md-10">
                        <div class="card">
                            <form action="{{route('user.updatepay3',$user->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                {{--@method('PUT')--}}
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-9">
                                            <input type="text" name="sala" class="form-control" id="job_type" value="{{$salaryscheds}}" hidden>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="salary_id" class="form-control" id="job_type" value="{{$salaryscheds}}" hidden>
