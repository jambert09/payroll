...
@section('content')
    ...
    <div class="">
        ...
        <div class="page-breadcrumb">
            ...
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center btn-block btn-lg btn-dark">
                    <a class="btn-sm btn-warning" href="{{route('view.list',$salarysched1->id)}}"data-position="center">As of {{$salarysched1->salary_date}} </a>
                    <a class="btn-lg btn-warning" href="#"data-position="center">Edit-OTU</a>
                    <a class="btn-lg btn-lg btn-success" href="#"data-position="center">{{$user->username}}</a>
                </div>
            </div>
        </div>
            <div id="app" class="container-fluid">
                <div class="row" v-for="(item, i) in items">
                    <div class="col-md-10">
                        <div class="card">
                            <form action="{{route('user.updateotu2',$user->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                {{--@method('PUT')--}}
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Edit OTU</h4>
                                    <div class="form-group row">
                                        <label for="job type" class="col-sm-3 text-right control-label col-form-label">Employee</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="" class="form-control" id="job_type" value="{{$user->username}}" disabled>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="" class="form-control " id="job_type" value="{{$salarysched1->id}}" hidden >
                                            <input type="text" name="" class="form-control " id="job_type" value="{{$salarysched1->salary_date}}" hidden >
                                        </div>
                                    </div>
                                    <div class="form-group row">

                                        <div class="col-sm-9">
                                            <input type="text" name="pay_id" class="form-control " id="job_type" value="{{$salarysched1->id}}{{$user->id}}" hidden >
                                        </div>
                                    </div>
                                    ...
                                    <h4 class="page-title"> <font color="red">Overtime Calculation</font></h4><input type="text" name="" class=" col-sm-3 form-control calc" id="rate" onkeyup="compute()"  value="{{$user->rate}}" placeholder="# of hrs" hidden>
                                    ...
                                    <div class="table-responsive">
                                        <table id="zero_config" class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                <th></th>
                                                <th></th>
                                                <th>No.of Minutes  <input type="text" name="" step="any" class=" col-sm-3 form-control calc" id="pmin" onkeyup="compute()"  value="{{$user->pmin}}" placeholder="# of hrs" hidden></th>
                                                <th>Amount</th>
...
<script>
    function compute(){
        ...
        f=Number(document.getElementById("rate").value);
