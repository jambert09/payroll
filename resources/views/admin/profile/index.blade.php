            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="box box-success">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title">Command</span>
                            </div>
                            <div class="panel-body pn pb5">
                                <hr class="short br-lighter">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <td>AAAAA</td>
                                            <td><strong><a href="{{route('user.edit',$user->id)}}" class="btn btn-sm btn-dark">Update Profie</a></strong></td>-->
                                       
                                        <tr>
                                           <!--   <td style="width: 10px" class="text-center"><i class="fa fa-credit-card"></i></td>
                                            <td><strong>Account Number</strong></td>
                                            <td>12**********2458</td>-->
                                            <td><strong><a href="{{route('change.password',$user->id)}}" class="btn btn-sm btn-dark">Update Password</a></strong></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                        </tr>
