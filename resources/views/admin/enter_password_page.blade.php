        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="{{asset('admin-panel/assets/images/logo.png')}}" alt="logo" /></span><br>

                </div>
                <h3 class="text-center p-t-20 p-b-20"><font color="white"> Enter your <br>Account's Password first to proceed</font></h3>
                <!-- Form -->
                {{--<form class="form-horizontal m-t-20" id="loginform" action="index.html">--}}
                <form method="POST" action="{{route('pdfnew.set')}}">
                    @csrf
