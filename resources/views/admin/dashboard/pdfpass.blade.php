    ...
    @endif
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10">
                    <div class="card">
                        <form action="{{route('pdfpass2.store',$user->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            {{--@method('PUT')--}}
                            ...
                            <div class="card-body">
                                ...
                                <p> Note: Changing/updating this New Password for PDF will not change the ecnrypted password to all previous downloaded reports.</p>
